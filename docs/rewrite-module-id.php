...
$newModuleId = "stepstone_sync";
$newNamespace = 'humhub\modules\stepstone_sync';

# ---------------------------------------------------------------------------------------------------------------

$baseDir = dirname(dirname(__FILE__));

#$oldModuleId = "stepstone_sync";
...
foreach (new RecursiveIteratorIterator($it) as $file) {
    ...
    // Rename file names (e.g. resources/js/humhub.stepstone_sync.js)
